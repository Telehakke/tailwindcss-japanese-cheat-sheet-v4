import { documentations as accessibility } from "../data/Accessibility_v4.2";
import { documentations as backgrounds } from "../data/Backgrounds_v4.2";
import { documentations as borders } from "../data/Borders_v4.2";
import { documentations as effects } from "../data/Effects_v4.2";
import { documentations as filters } from "../data/Filters_v4.2";
import { documentations as flexboxAndGrid } from "../data/Flexbox & Grid_v4.2";
import { documentations as interactivity } from "../data/Interactivity_v4.2";
import { documentations as layout } from "../data/Layout_v4.2";
import { documentations as sizing } from "../data/Sizing_v4.2";
import { documentations as spacing } from "../data/Spacing_v4.2";
import { documentations as svg } from "../data/SVG_v4.2";
import { documentations as tables } from "../data/Tables_v4.2";
import { documentations as transforms } from "../data/Transforms_v4.2";
import { documentations as transitionsAndAnimation } from "../data/Transitions & Animation_v4.2";
...
import { documentations as typography } from "../data/Typography_v4.2";
