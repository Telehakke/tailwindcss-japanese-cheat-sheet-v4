...
const sizingJA = new Map<string, Translation>([
    ...
    [
        "inline-size",
        {
            entry: "インラインサイズ",
            description:
                "1行の長さを指定する（横書き = width、縦書き = height）",
            details: [
                ["（数値）", "任意の長さで指定"],
                ["（分数）", "親要素に対する任意の割合で指定"],
                ["（3xs–7xl）", "プリセット値を使用"],
    ...
    [
        "min-inline-size",
        {
            entry: "最小インラインサイズ",
            description:
                "1行の最小長さを指定する（横書き = min-width、縦書き = min-height）",
            details: [
                ["（数値）", "任意の長さで指定"],
                ["（分数）", "親要素に対する任意の割合で指定"],
                ["（3xs–7xl）", "プリセット値を使用"],
    ...
    [
        "max-inline-size",
        {
            entry: "最大インラインサイズ",
            description:
                "1行の最大長さを指定する（横書き = max-width、縦書き = max-height）",
            details: [
                ["（分数）", "親要素に対する任意の割合で指定"],
                ["（3xs–7xl）", "プリセット値を使用"],
                ["none", "最大長さを指定しない"],
    ...
    [
        "block-size",
        {
            entry: "ブロックサイズ",
            description:
                "1行の厚みを指定する（横書き = height、縦書き = width）",
            details: [
                ["（数値）", "任意の厚みで指定"],
                ["（分数）", "親要素に対する任意の割合で指定"],
                ["auto", "自動"],
    ...
    [
        "min-block-size",
        {
            entry: "最小ブロックサイズ",
            description:
                "1行の最小厚みを指定する（横書き = min-height、縦書き = min-width）",
            details: [
                ["（数値）", "任意の厚みで指定"],
                ["（分数）", "親要素に対する任意の割合で指定"],
                ["px", "1pxで指定"],
    ...
    [
        "max-block-size",
        {
            entry: "最大ブロックサイズ",
            description:
                "1行の最大厚みを指定する（横書き = max-height、縦書き = max-width）",
            details: [
                ["（数値）", "任意の厚みで指定"],
                ["（分数）", "親要素に対する任意の割合で指定"],
                ["none", "最大厚みを指定しない"],
