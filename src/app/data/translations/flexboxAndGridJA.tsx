    ...
    [
        "align-content",
        {
            ...
            details: [
                ...
                ["evenly", "各空間の高さが等しくなるように子要素を配置する"],
                ["baseline", "startと同じ動作"],
                [
                    "stretch",
                    "隙間を埋めるように子要素を引き延ばして配置する（gridで有効）",
    ...
    [
        "align-items",
        {
            ...
            details: [
                ...
                ["baseline-last", "最終行のベースラインに揃えて配置する"],
                ["stretch", "セルの隙間を埋めるように子要素を引き延ばす"],
            ],
        },
    ],
