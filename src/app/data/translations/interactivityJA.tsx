...
export const interactivityJA = new Map<string, Translation>([
    ...
    [
        InteractivityEnum.scrollbarColor,
        {
            entry: "スクロールバーの色",
            description: `スクロールバーの色を指定する\n'scrollbar-thumb-（色）'でつまみの色を、'scrollbar-track-（色）'でトラックの色を指定できる`,
            details: [
                [
                    "inherit",
                    "親要素からスタイルを引き継ぐ",
    ...
    [
        InteractivityEnum.scrollbarWidth,
        {
            entry: "スクロールバーの幅",
            description: "スクロールバーの幅を指定する",
            details: [
                ["auto", "デフォルト"],
                ["thin", "細身"],
                ["none", "非表示"],
    ...
    [
        InteractivityEnum.scrollbarGutter,
        {
            entry: "スクロールバーの溝",
            description: "スクロールバー用の空間を確保する方法を指定する",
            details: [
                ["auto", "デフォルト"],
                ["stable", "スクロールバーの有無に関係なく空間を確保"],
                ["both", "要素の両側に空間を確保"],
            ],
        },
    ],
    [
        InteractivityEnum.scrollMargin,
        {
            ...
            details: [
                ...
                ["mx-（数値）", "水平方向に余白を与える"],
                ["my-（数値）", "垂直方向に余白を与える"],
                ["ms-（数値）", "日本語・横書き = ml、縦書き = mt"],
                ["me-（数値）", "日本語・横書き = mr、縦書き = mb"],
                ["mbs-（数値）", "日本語・横書き = mt、縦書き = mr"],
                ["mbe-（数値）", "日本語・横書き = mb、縦書き = ml"],
                ["mt-（数値）", "上側に余白を与える"],
                ["mr-（数値）", "右側に余白を与える"],
                ["mb-（数値）", "下側に余白を与える"],
                ["ml-（数値）", "左側に余白を与える"],
    ...
    [
        InteractivityEnum.scrollPadding,
        {
            ...
            details: [
                ...
                ["px-（数値）", "水平方向に余白を与える"],
                ["py-（数値）", "垂直方向に余白を与える"],
                ["ps-（数値）", "日本語・横書き = pl、縦書き = pt"],
                ["pe-（数値）", "日本語・横書き = pr、縦書き = pb"],
                ["pbs-（数値）", "日本語・横書き = pt、縦書き = pr"],
                ["pbe-（数値）", "日本語・横書き = pb、縦書き = pl"],
                ["pt-（数値）", "上側に余白を与える"],
                ["pr-（数値）", "右側に余白を与える"],
                ["pb-（数値）", "下側に余白を与える"],
                ["pl-（数値）", "左側に余白を与える"],
