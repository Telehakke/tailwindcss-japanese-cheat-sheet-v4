...
export const documentations = [
    ...
    },
    {
        ...
        "parameters": [
            ...
            [
                "bg-mauve-50",
                "background-color: var(--color-mauve-50); /* oklch(98.5% 0 0) */"
            ],
            [
                "bg-mauve-100",
                "background-color: var(--color-mauve-100); /* oklch(96% 0.003 325.6) */"
            ],
            [
                "bg-mauve-200",
                "background-color: var(--color-mauve-200); /* oklch(92.2% 0.005 325.62) */"
            ],
            [
                "bg-mauve-300",
                "background-color: var(--color-mauve-300); /* oklch(86.5% 0.012 325.68) */"
            ],
            [
                "bg-mauve-400",
                "background-color: var(--color-mauve-400); /* oklch(71.1% 0.019 323.02) */"
            ],
            [
                "bg-mauve-500",
                "background-color: var(--color-mauve-500); /* oklch(54.2% 0.034 322.5) */"
            ],
            [
                "bg-mauve-600",
                "background-color: var(--color-mauve-600); /* oklch(43.5% 0.029 321.78) */"
            ],
            [
                "bg-mauve-700",
                "background-color: var(--color-mauve-700); /* oklch(36.4% 0.029 323.89) */"
            ],
            [
                "bg-mauve-800",
                "background-color: var(--color-mauve-800); /* oklch(26.3% 0.024 320.12) */"
            ],
            [
                "bg-mauve-900",
                "background-color: var(--color-mauve-900); /* oklch(21.2% 0.019 322.12) */"
            ],
            [
                "bg-mauve-950",
                "background-color: var(--color-mauve-950); /* oklch(14.5% 0.008 326) */"
            ],
            [
                "bg-olive-50",
                "background-color: var(--color-olive-50); /* oklch(98.8% 0.003 106.5) */"
            ],
            [
                "bg-olive-100",
                "background-color: var(--color-olive-100); /* oklch(96.6% 0.005 106.5) */"
            ],
            [
                "bg-olive-200",
                "background-color: var(--color-olive-200); /* oklch(93% 0.007 106.5) */"
            ],
            [
                "bg-olive-300",
                "background-color: var(--color-olive-300); /* oklch(88% 0.011 106.6) */"
            ],
            [
                "bg-olive-400",
                "background-color: var(--color-olive-400); /* oklch(73.7% 0.021 106.9) */"
            ],
            [
                "bg-olive-500",
                "background-color: var(--color-olive-500); /* oklch(58% 0.031 107.3) */"
            ],
            [
                "bg-olive-600",
                "background-color: var(--color-olive-600); /* oklch(46.6% 0.025 107.3) */"
            ],
            [
                "bg-olive-700",
                "background-color: var(--color-olive-700); /* oklch(39.4% 0.023 107.4) */"
            ],
            [
                "bg-olive-800",
                "background-color: var(--color-olive-800); /* oklch(28.6% 0.016 107.4) */"
            ],
            [
                "bg-olive-900",
                "background-color: var(--color-olive-900); /* oklch(22.8% 0.013 107.4) */"
            ],
            [
                "bg-olive-950",
                "background-color: var(--color-olive-950); /* oklch(15.3% 0.006 107.1) */"
            ],
            [
                "bg-mist-50",
                "background-color: var(--color-mist-50); /* oklch(98.7% 0.002 197.1) */"
            ],
            [
                "bg-mist-100",
                "background-color: var(--color-mist-100); /* oklch(96.3% 0.002 197.1) */"
            ],
            [
                "bg-mist-200",
                "background-color: var(--color-mist-200); /* oklch(92.5% 0.005 214.3) */"
            ],
            [
                "bg-mist-300",
                "background-color: var(--color-mist-300); /* oklch(87.2% 0.007 219.6) */"
            ],
            [
                "bg-mist-400",
                "background-color: var(--color-mist-400); /* oklch(72.3% 0.014 214.4) */"
            ],
            [
                "bg-mist-500",
                "background-color: var(--color-mist-500); /* oklch(56% 0.021 213.5) */"
            ],
            [
                "bg-mist-600",
                "background-color: var(--color-mist-600); /* oklch(45% 0.017 213.2) */"
            ],
            [
                "bg-mist-700",
                "background-color: var(--color-mist-700); /* oklch(37.8% 0.015 216) */"
            ],
            [
                "bg-mist-800",
                "background-color: var(--color-mist-800); /* oklch(27.5% 0.011 216.9) */"
            ],
            [
                "bg-mist-900",
                "background-color: var(--color-mist-900); /* oklch(21.8% 0.008 223.9) */"
            ],
            [
                "bg-mist-950",
                "background-color: var(--color-mist-950); /* oklch(14.8% 0.004 228.8) */"
            ],
            [
                "bg-taupe-50",
                "background-color: var(--color-taupe-50); /* oklch(98.6% 0.002 67.8) */"
            ],
            [
                "bg-taupe-100",
                "background-color: var(--color-taupe-100); /* oklch(96% 0.002 17.2) */"
            ],
            [
                "bg-taupe-200",
                "background-color: var(--color-taupe-200); /* oklch(92.2% 0.005 34.3) */"
            ],
            [
                "bg-taupe-300",
                "background-color: var(--color-taupe-300); /* oklch(86.8% 0.007 39.5) */"
            ],
            [
                "bg-taupe-400",
                "background-color: var(--color-taupe-400); /* oklch(71.4% 0.014 41.2) */"
            ],
            [
                "bg-taupe-500",
                "background-color: var(--color-taupe-500); /* oklch(54.7% 0.021 43.1) */"
            ],
            [
                "bg-taupe-600",
                "background-color: var(--color-taupe-600); /* oklch(43.8% 0.017 39.3) */"
            ],
            [
                "bg-taupe-700",
                "background-color: var(--color-taupe-700); /* oklch(36.7% 0.016 35.7) */"
            ],
            [
                "bg-taupe-800",
                "background-color: var(--color-taupe-800); /* oklch(26.8% 0.011 36.5) */"
            ],
            [
                "bg-taupe-900",
                "background-color: var(--color-taupe-900); /* oklch(21.4% 0.009 43.1) */"
            ],
            [
                "bg-taupe-950",
                "background-color: var(--color-taupe-950); /* oklch(14.7% 0.004 49.3) */"
            ],
            [
                "bg-(<custom-property>)",
